# KUDOS TO https://medium.com/towards-formula-1-analysis/how-to-analyze-formula-1-telemetry-in-2022-a-python-tutorial-309ced4b8992
...
year, grand_prix, session = 2022, 'Mexico', 'Q'

#driver_1, driver_2 = 'PER', 'LEC'
driver_1, driver_2 = 'VER', 'RUS'

use_dark = True
output_ext = 'pdf' # pdf png... 
...
plot_filename = plot_title.replace(" ", "") + "." + output_ext
